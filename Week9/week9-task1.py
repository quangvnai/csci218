...
def main():
    ...
    problem = GraphProblem(initial='Fagaras', goal='Zerind', graph=romania_map)

    print('------ Breadth First Graph Search ------')
    start = timer()
    results = breadth_first_graph_search(problem)
    end = timer()
    print(f'Solution: {results.solution()}')  # we can use results.path()
